...
<main class="container dashboard-main d-flex flex-column">
    <h1 class="display-4 mb-3">Find Recipes Using Any Parameter</h1>
...
<%--    &lt;%&ndash;Here's an example how to display complex-search.&ndash;%&gt;--%>
<%--    <div class="mt-5">--%>
