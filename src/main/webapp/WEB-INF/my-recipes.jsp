        ...
        <div class="container-fluid">
            <a class="navbar-brand d-flex align-items-center" href="/">
                ...
                <div class="d-flex gap-3">
                    ...
                    <a class="nav-link text-dark" style="font-size: .9rem; font-family: 'Playpen Sans', sans-serif;" href="/recipes/${user.id}">My recipes</a>
                    <a class="nav-link text-dark ms-3" style="font-size: .9rem; font-family: 'Playpen Sans', sans-serif;" href="/logout">Logout</a>
                </div>
            </a>
        </div>
    </nav>
...
<div class="container mt-5">
    <h1 class="text-dark text-center" style="font-size: 2rem">My Saved Recipes</h1>

    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 mt-4">
        <c:forEach var="recipe" items="${savedRecipes}">
            <div class="col d-flex align-items-stretch">
                <div class="card shadow card-blur h-100" style="border: none;">
                    <img src="${recipe.image}" alt="${recipe.title}" class="card-img-top img-fluid rounded" style="border-radius: 30px; overflow: hidden;">
